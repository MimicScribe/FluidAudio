...
struct OfflineReconstruction {
    ...
    /// `OfflineDiarizerManager.clusterCapturingFrameGrid` to expose
    ...
    func buildSegmentsCapturingFrameGrid(
        ...
        // Dump reflects the post-reembed assignments actually used to build
        // segments below (zero-vote reembed above may have mutated perFrameClusters).
